...
import RecentUsed from './components/RecentUsed.vue'
...
<template>
  <div class="min-h-screen bg-bg text-ink">
    ...
    <div class="flex">
      ...
      <div
        v-if="mobileOpen"
        class="fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-line p-3 overflow-y-auto"
      >
        <div class="flex justify-end mb-2">
          <button
            class="text-muted hover:text-ink px-2 py-1 rounded-lg"
            @click="mobileOpen = false"
          >
            ✕
          </button>
